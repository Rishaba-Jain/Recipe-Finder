...
class DatabaseHelper {
  static const _databaseName = 'MyRecipes1.db';
  ...
  // since _database is private, we need to create a getter
  ...
  Future<List<Ingredient>> findAllIngredients() async {
    final db = await instance.streamDatabase;
    final inrgedientList = await db.query(ingredientTable);
    final ingredients = parseIngredients(inrgedientList);
    return ingredients;
  }
